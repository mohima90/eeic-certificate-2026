...
/**
 * Navbar — exact HTML from resources/views/admin/layout/navbar.blade.php
 */
            ...
            >
              ...
              >
                <div className="menu-item me-lg-1">
                  <a className="menu-link active py-3" href="/dashboard">
              ...
              <div className="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                ...
                >
                  ...
                  <div className="menu-item px-5">
                    <button
                      className="menu-link px-5 border-0 bg-transparent w-100 text-start"
