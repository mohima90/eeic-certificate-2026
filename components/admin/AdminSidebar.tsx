...
/**
 * Sidebar — exact HTML from resources/views/admin/layout/sidebar.blade.php
 */
  ...
  return (
    ...
    >
      ...
      <div className="aside-logo flex-column-auto" id="kt_aside_logo">
        <div>
          <img alt="Logo" src="/assets/media/logos/side.png" className="h-25px logo" />
        </div>
        <div
          id="kt_aside_toggle"
            ...
            {navItems.map(item => {
              ...
              return (
                <div key={item.href} className="menu-item">
                  <Link className={`menu-link ${active ? 'active' : ''}`} href={item.href}>
